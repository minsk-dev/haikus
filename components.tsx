        ...
        <div class="pt-12 first:pt-0">
            ...
            <p class="text-gray-500/80">
                ...
                <PrettyDate
                    ...
                    dateFormat={dateFormat}
                />
                {post.snippet && <span>{` | ${post.snippet}`}</span>}
            </p>
            <p
                dangerouslySetInnerHTML={{__html: html}}
                class="mt-3 text-gray-600 dark:text-gray-400"></p>
            <p class="mt-3">
                <a
...
function Footer() {
    return (
        <footer class="mt-20 pb-16 lt-sm:pb-8 lt-sm:mt-16">
            <p class="flex items-center justify-between gap-2.5 text-gray-400/800 dark:text-gray-500/800 text-sm">
        <span>
          powered by{" "}
            <a
            ...
            <span>. code can be found <a class="inline-flex items-center gap-1 underline hover:text-gray-800 dark:hover:text-gray-200 transition-colors" href="https://github.com/minsk-dev/haikus">here</a></span>
        </span>
                <a
                    href="/feed"
